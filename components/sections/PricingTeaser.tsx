  ...
  return (
    <section className="py-24 bg-gray-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          <span className="inline-flex items-center gap-2 bg-green-500/10 border border-green-500/20 text-green-400 rounded-full px-4 py-1.5 text-sm font-semibold mb-4">
            💰 Transparent Pricing
          </span>
          ...
          {PLANS.map((plan, i) => (
            <motion.div
              ...
              className={`relative rounded-3xl p-8 border transition-all duration-300 hover:-translate-y-2 ${
                plan.popular
                  ? 'bg-gradient-to-b from-green-900/40 to-gray-900/60 border-green-500/50 shadow-2xl shadow-green-500/20'
        ...
        >
          ...
          <Link href="/pricing">
            <Button variant="outline" className="border-gray-700 text-gray-400 hover:text-white hover:border-gray-500 rounded-xl">
