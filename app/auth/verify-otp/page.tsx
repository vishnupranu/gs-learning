    ...
    <>
      ...
      <div className="flex gap-3 justify-center mb-8" onPaste={handlePaste}>
        {otp.map((digit, i) => (
          <input
            ...
            className={`w-12 h-14 text-center text-2xl font-black rounded-2xl border-2 bg-gray-900 text-white outline-none transition-all ${
              digit
      ...
      <div className="text-center">
        ...
        <button
          ...
          className="text-green-400 hover:text-green-300 font-semibold text-sm disabled:text-gray-600 disabled:cursor-not-allowed transition-colors"
        >
      ...
      >
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-green-400 font-semibold mt-1">{decodeURIComponent(String(new URLSearchParams(typeof window !== 'undefined' ? window.location.search : '').get('email') || ''))}</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <Link href="/auth/login" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">
              ← Back to Sign In
            </Link>
          </div>
        </div>
